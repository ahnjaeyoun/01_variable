...
public class VariableExample2 {
	...
	short shortNumer = 32767; // 변수 선언 및 초기화
	
	// 정수 자료형 기본형! (short, byte는 옛날 고드 잔재)
...
// 자료형 변수명 = 리터럴;
	...
	// -> 100억 이라는 값은 int의 범위를 벗어났다! 21억 몇 까지만 가능..
	// 뒤에 L을 붙어줌으로써 long 자료형인것을 나타냄.
	
	
	float floatNumber = 1.2345f; // F 또는 소문자 f
	// 1.2345까지만 쓰면 에러남. 자료형 맨 앞글자인 f 쓰기(int가 기본형이기 때문)
	 ...
	 * 
	 * - 상수 명명 규치 : 모두 대문자, 여러단어 작성 시 _ 사용
	 * 
	 * - 상수를 사용하는 경우
